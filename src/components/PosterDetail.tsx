...
const PosterDetail = ({ poster, onClose }: PosterDetailProps) => {
  ...
  const handleWhatsAppOrder = () => {
    ...
    window.open(
      `https://wa.me/919460970342?text=${message}`,
      "_blank"
    );
  };

  const suggestedPosters = posters.filter(p => 
        ...
        <div className="grid gap-0 md:grid-cols-2">
          ...
          <div className="flex flex-col p-6 md:p-8">
            ...
            <Button
              ...
              className="mb-6 w-full gap-2 bg-whatsapp text-whatsapp-foreground hover:bg-whatsapp/90"
              size="lg"
            >
